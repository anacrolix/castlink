...
var _user$project$NamedEscapes$codeToStr = function (_p1) {
	return _elm_lang$core$String$fromChar(
		_elm_lang$core$Char$fromCode(_p1));
};
var _user$project$NamedEscapes$headSubm = function (_p2) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(
...
var _user$project$NamedEscapes$subm = function (_p3) {
	return _user$project$NamedEscapes$headSubm(
		function (_) {
			return _.submatches;
		}(_p3));
};
var _user$project$NamedEscapes$uncompress = function (str) {
	var bToZ = A2(
		_elm_lang$core$List$map,
		_user$project$NamedEscapes$codeToStr,
		A2(_elm_lang$core$List$range, 98, 122));
	var expand = A3(
		_user$project$NamedEscapes$regexAll,
		...
		function (_p4) {
			return A3(
				...
				_elm_lang$core$String$join,
				bToZ,
				_user$project$NamedEscapes$subm(_p4));
		});
	...
	var applyKey = function (match) {
		...
		return function (_p5) {
			return A2(
				_elm_lang$core$String$join,
				_user$project$NamedEscapes$subm(match),
				A2(
					_elm_lang$core$String$split,
					_user$project$NamedEscapes$codeToStr((381 - (((n / 206) | 0) * 49)) - n),
					_p5));
		};
	};
	return function (_p6) {
		return expand(
			shift(
				A3(
					...
					applyKey,
					str,
					A3(_user$project$NamedEscapes$regexAll, _elm_lang$core$Regex$find, '([^ ]+) ', _p6))));
	};
};
var _user$project$NamedEscapes$submPair = function (match) {
	var subms = match.submatches;
	return {
		ctor: '_Tuple2',
		_0: _user$project$NamedEscapes$headSubm(subms),
		_1: _user$project$NamedEscapes$headSubm(
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '[]'},
...
var _user$project$NamedEscapes$getEscapes = F2(
	function (matches, escapes) {
		getEscapes:
		while (true) {
			var _p7 = matches;
			if (_p7.ctor === '::') {
				var _p8 = _user$project$NamedEscapes$submPair(_p7._0);
				var esc = _p8._0;
				var code = _p8._1;
				var _p9 = A2(
					_elm_lang$core$Maybe$withDefault,
				...
				var _v1 = _p7._1,
					_v2 = {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: thisEsc, _1: thisCode},
					_1: escapes
				};
				matches = _v1;
				escapes = _v2;
...
var _user$project$NamedEscapes$extractEscapes = function (str) {
	return function (_p10) {
		return A3(
			_elm_lang$core$Basics$flip,
			_user$project$NamedEscapes$getEscapes,
			{ctor: '[]'},
			A3(
				_user$project$NamedEscapes$regexAll,
				_elm_lang$core$Regex$find,
				'(\\w+)(\\W+)',
				A2(_user$project$NamedEscapes$uncompress, str, _p10)));
	};
};
var _user$project$NamedEscapes$namedEscapes = A2(_user$project$NamedEscapes$extractEscapes, _user$project$NamedEscapes$compressed, _user$project$NamedEscapes$keys);
var _user$project$NamedEscapes$getNamedEscape = A2(_elm_lang$core$Basics$flip, _elm_lang$core$Dict$get, _user$project$NamedEscapes$namedEscapes);

var _user$project$Handlers$hexToInt = function (_p0) {
	return A3(
		_elm_lang$core$String$foldl,
		F2(
...
var _user$project$Handlers$escapeTypes = {
	ctor: '::',
	_0: {
		ctor: '_Tuple2',
		_0: '&#x([0-9a-fA-F]+);',
		_1: function (_p1) {
			return _elm_lang$core$Maybe$Just(
				_user$project$Handlers$hexToInt(_p1));
		}
	},
	_1: {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '&([0-9a-zA-Z]+);', _1: _user$project$NamedEscapes$getNamedEscape},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Handlers$handleMatches = function (regEx) {
	var handleMatch = F2(
		function (sToCode, m) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				...
				A2(
					...
					_user$project$NamedEscapes$codeToStr,
					sToCode(
						_user$project$NamedEscapes$subm(m))));
		});
	return function (_p3) {
		return A3(
			_user$project$NamedEscapes$regexAll,
...
var _user$project$Handlers$handleEscapes = A2(
	_elm_lang$core$Basics$flip,
	_elm_lang$core$List$foldl(
		_elm_lang$core$Basics$uncurry(_user$project$Handlers$handleMatches)),
	_user$project$Handlers$escapeTypes);

var _user$project$Unicode$unEsc = _user$project$Handlers$handleEscapes;
var _user$project$Unicode$text_ = function (_p0) {
	return _elm_lang$html$Html$text(
		_user$project$Unicode$unEsc(_p0));
};
